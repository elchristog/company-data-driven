...
def add_study_guide(user_id, project_name):
    ...
    if file_url is not None and guide_name is not None and selected_lesson is not None and selected_subject is not None and selected_language is not None and selected_folder is not None:
