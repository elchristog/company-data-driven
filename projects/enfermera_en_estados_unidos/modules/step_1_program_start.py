...
def cv_creation_guide():
    st.markdown('''
    **El dia 1 debes indicarle al usuario que vas a estar trabajando en la creacion de Curriculum para los requisitos de Estados Unidos, pidele su Curriculum actual y tambien su URL de linkedin, Entregale el CV a los 7 dias subiendolo al Drive de la persona (Se sube el .md el .pdf y el pdf de como editar el cv [Descargar](https://drive.google.com/uc?export=download&id=1bvoaWduRqa7EdOV5dRpOo8YMmb_LhclZ))**
