...
def architect(user_id, role_id, project_id, project_name, project_title, project_icon, project_logo_url):
    ...
    if role_id != 6:
        with st.sidebar:
            ...
            menu_options = ["Home", "Trafico y SEO", "Click bitly", "Whatsapp", "Trip Wire", "Remarketing", "Web tool", "Contract", "Contract Remarketing", "Step1", "Step2"]
            if role_id == 1:
    ...
    if role_id == 6:
        ...
        if menu == "Nclex":
            ...
            if sub_menu == "Simulacro":
                ...
                tst.tester(project_name, 'nclex_questions_sample', user_id)