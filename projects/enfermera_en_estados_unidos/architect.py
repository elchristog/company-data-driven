    ...
    if role_id != 6:
        ...
        if menu == "Traffic":
            ...
            if sub_menu == "Content creation guide":
                tap.title_and_paragraph("Creacion de contenido" + project_icon, "Usa un editor externo primero, pasa cada bloque de texto por https://www.text-utils.com/remove-special-characters/ antes de ponerlo aca", "h3", 0)
