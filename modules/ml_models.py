...
def ml_purchase_propension_save_threshold_and_metrics():
    ...
    if 'processed_data_query' in st.session_state:
        ...
        if len(model_trained_today) > 0:
            ...
            st.toast('primera vez del dia')
            uc.run_query_insert_update(f"INSERT INTO `company-data-driven.{st.session_state.ml_purchase_propension_project_name}.purchase_propension_model_training_log` (id,trained_user_id,training_date,selected_threshold,evaluation_data_precision,evaluation_data_recall,evaluation_data_accuracy,evaluation_data_f1_score,evaluation_data_log_loss,evaluation_data_roc_auc,evaluation_data_confussion_matrix_expected_0_predicted_0,evaluation_data_confussion_matrix_expected_0_predicted_1,evaluation_data_confussion_matrix_expected_1_predicted_0,evaluation_data_confussion_matrix_expected_1_predicted_1) VALUES( GENERATE_UUID(), {st.session_state.ml_purchase_propension_user_id}, CURRENT_DATE(), {st.session_state.ml_purchase_propension_threshold}, st.session_state.evaluation_metrics[0].get('precision'), st.session_state.evaluation_metrics[0].get('recall'), st.session_state.evaluation_metrics[0].get('accuracy'), st.session_state.evaluation_metrics[0].get('f1_score'), st.session_state.evaluation_metrics[0].get('log_loss'), st.session_state.evaluation_metrics[0].get('roc_auc'), {st.session_state.confussion_matrix[0].get('_0')}, {st.session_state.confussion_matrix[0].get('_1')}, {st.session_state.confussion_matrix[1].get('_0')}, {st.session_state.confussion_matrix[1].get('_1')});")
...
def ml_purchase_propension(user_id, project_name):
    ...
    # Showing confussion matrix and lift chart in last evaluation data (last model retrain)
