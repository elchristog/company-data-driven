        ...
        if selected_username is not None:
            ...
            if create_task_button:
                if selected_user_id is None or task_input is None or len(task_input) < 10 or commitment_date_input is None:
                    ...
                    st.write(f"INSERT INTO `company-data-driven.{project_name}.tasks` (id, creation_date, description, responsible_user_id, responsible_user_id, status, task_creator_id) VALUES({max_id}, {today_str}, {task_input}, {selected_user_id}, 'to_start', {role_id})")
