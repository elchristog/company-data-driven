...
def customer_success_add_program_step_execution():
    ...
    if 'customer_success_add_program_step_selected_program_step' in st.session_state:
        ...
        uc.run_query_insert_update(f"UPDATE `company-data-driven.{st.session_state.customer_success_add_program_steps_project_name}.program_steps` SET order_number = order_number + 1 WHERE order_number > {st.session_state.customer_success_add_program_step_selected_step_order_number}")
        uc.run_query_insert_update(f"INSERT INTO `company-data-driven.{st.session_state.customer_success_add_program_steps_project_name}.program_steps` (order_number, creation_date, name, description, id, creator_user_id, know_how, tasks, texts) VALUES ({st.session_state.customer_success_add_program_step_selected_step_order_number + 1}, CURRENT_DATE(), '{st.session_state.customer_success_add_program_step_step_name}', '{st.session_state.customer_success_add_program_step_step_description}', GENERATE_UUID(), st.session_state.customer_success_add_program_step_user_id, '{st.session_state.customer_success_add_program_step_know_how}', '{st.session_state.customer_success_add_program_step_tasks_array}', '{st.session_state.customer_success_add_program_step_chat_texts}')")
