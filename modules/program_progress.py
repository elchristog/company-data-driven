...
def customer_success_crm_add_contact_execution():
    ...
    if 'customer_success_crm_add_contact_selected_username' in st.session_state:
        ...
        if st.session_state.customer_success_crm_add_contact_selected_program_step in ['Aceptación de documentos por la entidad evaluadora', 'Aprobación del examen de inglés', 'Aprobación del examen NCLEX', 'Obtención de oferta de trabajo']:
