...
def customer_success_crm_add_contact_execution():
    ...
    if 'customer_success_crm_add_contact_selected_username' in st.session_state:
        ...
        if st.session_state.customer_success_crm_add_contact_selected_program_step in ['Aprobación del examen de inglés', 'Aprobación del examen NCLEX', 'Obtención de una oferta de trabajo', 'Inicio del proceso de emigración']:
