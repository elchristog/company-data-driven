...
def customer_success_add_program_step(user_id, project_name):
    ...
    days_to_complete_tasks = st.number_input('Days to complete tasks', key = 'customer_success_add_program_step_days_to_complete_tasks', min_value = 0, max_value = 90, step = 5, help = "Dias en que la persona debe cumplir sus tareas")
