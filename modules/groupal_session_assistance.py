...
def groupal_session_team_member_performance(user_id, project_name):
    ...
    team_member_contacts_week = team_member_contacts[(team_member_contacts["year_contact"] == str(today.year)) & (team_member_contacts["month_contact"] == str(today.month)) & (team_member_contacts["week_contact"] == str(corrected_week))]
